package com.patbaumgartner.observability.metrics;
...
public class BeerCustomMetricsController {
	...
	// Metrics principle: "never gauge something you can count, never count
	...
	BeerCustomMetricsController(MeterRegistry meterRegistry) {
		...
		distributionSummary = DistributionSummary.builder("beer.prices")
	...
	private static Order toOrder(Long l) {
		...
		double price = ThreadLocalRandom.current().nextDouble() * 10;
